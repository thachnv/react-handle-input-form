...
module.exports = {
  ...
  module: {
    loaders: [
      ...
      {
        test: /\.ttf(\?\S*)?/,
        loader: 'url-loader?name=assets/[name].[ext]&limit=100000&mimetype=application/font-ttf'
      },
      {
        test: /\.svg(\?\S*)?/,
        loader: 'url-loader?name=assets/[name].[ext]&limit=100000&mimetype=application/font-svg'
      },
    ]
  },
